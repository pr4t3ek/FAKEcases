...
to end: ~55,000 lines of TypeScript, 50 test suites, 12 product surfaces, 63 seeded
exercises (30 guesstimates, 10 cases, 23 simulations). Runs fully offline with zero API
...
- **Free account** — the same content, plus saved progress, streaks, a percentile rank and a
  profile.
- **Pro, ₹499/month** — the full library: 30 guesstimates, all 10 cases, all 23 war rooms.
...
- **63 exercises** — 30 guesstimates, 10 cases, 23 war rooms, all India-context.
