...
to end: ~55,000 lines of TypeScript, 50 test suites, 12 product surfaces, 65 seeded
exercises (30 guesstimates, 10 cases, 25 simulations). Runs fully offline with zero API
...
- **Free account** — the same content, plus saved progress, streaks, a percentile rank and a
  profile.
- **Pro, ₹499/month** — the full library: 30 guesstimates, all 10 cases, all 25 war rooms.
...
- **65 exercises** — 30 guesstimates, 10 cases, 25 war rooms, all India-context.
