...
📘 **[User guide](docs/USER_GUIDE.pdf)** ([Word](docs/USER_GUIDE.docx)) — what the platform is for
and how to use it, for students and faculty. Written in
[`docs/user-guide/USER_GUIDE.md`](docs/user-guide/USER_GUIDE.md); the screenshots and both
documents are regenerated by the scripts beside it.
