 ...
 */
export const QUESTION_CSV_TEMPLATE = `title,prompt,category,difficulty,interviewLevel,type,idealLow,idealHigh,unit,framework,expectedBuckets,rootCause,dataPack,betterApproach,sampleSolution,tags,externalId
Number of ATMs in Chennai,Estimate the number of ATMs in Chennai.,finance,Medium,McKinsey,guesstimate,3000,8000,ATMs,,,,,"Estimate bank branches and ATMs per branch, plus standalone/white-label ATMs.","~1 cr people, banked population, ATMs per 10k people ~5-8 -> ~5000 ATMs.","banking,india",atms-chennai
Why are Swiggy's margins falling?,"Swiggy's contribution margin per order in Bengaluru has fallen 30% over two years. Why?",startups,Hard,BCG,qualitative,,,,profitability,Revenue|Cost|Order volume|Competition,"{""path"":[""Cost"",""Delivery cost per order""],""note"":""Rider payouts rose faster than order value.""}","[{""topic"":[""cost"",""delivery""],""fact"":""Rider cost per order rose from Rs 42 to Rs 61.""}]","Split contribution margin into revenue per order and cost per order before drilling.","Delivery cost per order is the driver; order value stayed flat while rider payouts rose ~45%.","food-delivery,india",swiggy-margins
`;
